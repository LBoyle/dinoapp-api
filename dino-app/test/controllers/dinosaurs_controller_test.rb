...
class DinosaursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinosaur" do
    assert_difference('Dinosaur.count') do
      post dinosaurs_url, params: { dinosaur: { description: @dinosaur.description, image: @dinosaur.image, name: @dinosaur.name, period: @dinosaur.period } }, as: :json
    end
  ...
  test "should update dinosaur" do
    patch dinosaur_url(@dinosaur), params: { dinosaur: { description: @dinosaur.description, image: @dinosaur.image, name: @dinosaur.name, period: @dinosaur.period } }, as: :json
    assert_response 200
  end
